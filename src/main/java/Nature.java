...
public class Nature {
    ...
    private String connect(String msg) {
        if (msg.equals("Тропы")){
            ...
            getTitle(document);
        }else if (msg.equals("Горы и скалы")){
            try {
            ...
            getTitle(document);
        }else if (msg.equals("Заповедники")){
            try {
